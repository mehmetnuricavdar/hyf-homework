...
function getOption() {
  ...
  const dateFilter = movies.filter((i) => i.year > fromDate && i.year < toDate);
  ...
  const averageRating = dateFilter.filter((i) => i.rating >= 4 && i.rating < 7);
  ...
  function ratingsFilter() {
    if (ratingScroreNumFrom === "--" && ratingScroreNumTo === "--") {
      ...
      ratingDisplay.innerHTML = "<h2>Movies ratings</h2>";
...
function findingWord() {
  ...
  console.log(counts);
  const findingWordDisplay = document.createElement("div");
  document.body.append(findingWordDisplay);
  findingWordDisplay.className = "findingWord-div"
  findingWordDisplay.innerHTML =
    "<h3> The total number of movies  containing any of following keywords: Surfer, Alien or Benjamin</h3>";
}
findingWord();
